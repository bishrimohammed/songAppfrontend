...
const FilterContiner = styled.div`
  width: 10rem;
`;
function AlbumStatistics() {
  const albums = useSelector(
    (state: SongsState) => state.songStatistics.Number_songs_albumStatistics
  );
  //const albums = albumsData.Number_songs_albumStatistics;
  ...
  return (
    <>
      <AlbumStatsContainer>
        <Text fontWeight={600}>Total number of Song in every Album</Text>
        <TableContainer>
          <AlbumTable>
            <thead>
              <tr>
                <TableHeader>Album Title</TableHeader>
